...
function dateIsBetween(whoIsBetween, start, end, unit, include) {
  ...
  return (0, import_dayjs.default)(whoIsBetween).isBetween((0, import_dayjs.default)(start), (0, import_dayjs.default)(end), unit, `${include?.start ? "[" : "("}${include?.end ? "]" : ")"}`);
}
...
var Footer = () => {
  const { hideDatepicker, period, changeDatepickerValue, configs, classNames: classNames2, input } = (0, import_react.useContext)(DatepickerContext);
  const getClassName = (0, import_react.useCallback)(() => {
    if (typeof classNames2 !== "undefined" && typeof classNames2?.footer === "function") {
...
var Input = () => {
  const { primaryColor, period, dayHover, changeDayHover, calendarContainer, arrowContainer, inputText, changeInputText, hideDatepicker, changeDatepickerValue, asSingle, placeholder, separator, disabled, inputClassName, toggleClassName, toggleIcon, readOnly, displayFormat, inputId, inputName, classNames: classNames2, popoverDirection, required, input, setInput } = (0, import_react.useContext)(DatepickerContext);
  const buttonRef = (0, import_react.useRef)(null);
  const inputRef = (0, import_react.useRef)(null);
  const getClassName = (0, import_react.useCallback)(() => {
    const input2 = inputRef.current;
    if (input2 && typeof classNames2 !== "undefined" && typeof classNames2?.input === "function") {
      return classNames2.input(input2);
    }
  ...
  const getToggleClassName = (0, import_react.useCallback)(() => {
    ...
    if (button && typeof classNames2 !== "undefined" && typeof classNames2?.toggleButton === "function") {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (div && input2) {
      input2.addEventListener("focus", showCalendarContainer);
    }
    return () => {
      if (input2) {
        input2.removeEventListener("focus", showCalendarContainer);
      }
    };
...
var ItemTemplate = (0, import_react.memo)((props) => {
  const { primaryColor, period, changePeriod, updateFirstDate, dayHover, changeDayHover, hideDatepicker, changeDatepickerValue, input } = (0, import_react.useContext)(DatepickerContext);
  const getClassName = (0, import_react.useCallback)(() => {
...
var Datepicker = (props) => {
  ...
  const [input, setInput] = (0, import_react.useState)(null);
  ...
  const contextValues = (0, import_react.useMemo)(() => {
    ...
    return {
      ...
      input,
      setInput: (value2) => setInput(value2),
      inputClassName,
      inputId,
      inputName,
      inputText,
