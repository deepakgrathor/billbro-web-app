...
const Contact = () => {
  ...
  const rightDesign = useCallback(() => (
    <div className="flex items-center gap-2">
      ...
      <p className="text-xs text-gray-700 font-bold">24×7 Support</p>
    </div>
  ), []);
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex flex-col relative overflow-hidden">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 442.137"
          className="w-32 absolute -top-24 -left-16 pointer-events-none animate-bounce-slow"
          fill="currentColor"
          style={{ color: '#10b981' }}
        >
          <path d="M498.536 442.137c-31.387-25.229-67.042-47.435-83.064-62.714-5.282-5.036-11.007-12.153-1.664-8.574 25.872 9.909 54.004 27.667 75.003 49.744-2.547-18.498 2.366-41.616 9.997-60.504.939-2.328 3.886-11.918 7.547-15.089 1.358-1.177 2.819-1.472 4.307-.18.849.739 1.28 1.995 1.333 3.707.152 4.983-3.387 19.558-6.693 33.835-4.904 21.183-7.422 37.783-6.766 59.775z"></path>
        ...
        >
          ...
          {/* Main Button */}
          <div className="relative w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 group-hover:scale-110 active:scale-95">
